...
from python import julia_cell as jc
...
class TestJuliaCell(unittest.TestCase):
    def test_get_current_cell_boundaries_cursor_start_of_cell(self):
        current_row = 8
        cell_start, cell_end = jc._get_current_cell_boundaries(current_row,
                                                               CELL_BOUNDARIES)
    ...
    def test_get_next_cell_cursor_start_of_cell(self):
        current_row = 8
        next_cell = jc._get_next_cell(current_row, CELL_BOUNDARIES)
    ...
    def test_get_prev_cell_cursor_start_of_cell(self):
        current_row = 8
        prev_cell = jc._get_prev_cell(current_row, CELL_BOUNDARIES)
    ...
    def test_get_rows_with_tag(self):
        ...
        rows = jc._get_rows_with_tag(buffer, "##")
    ...
    def test_get_rows_with_marks(self):
        ...
        rows = jc._get_rows_with_marks(buffer, valid_marks='abcdefg')
        self.assertEqual(rows, [2])
